...
FILE_PATH = "/Users/khaz/Documents/"
DATA = FILE_PATH + "Projectdata.csv"
OUTPUT = FILE_PATH + "CleanData_v2.csv"
...
with open(OUTPUT, 'w', newline='') as f:
    fieldnames = ['student_name', 'elective_courses']
    writer = csv.DictWriter(f, fieldnames=fieldnames)

    writer.writeheader()
    for k,v in phase33.items():
        # comb = ",".join(v)
        for subj in v:
            writer.writerow({'student_name': k, 'elective_courses': subj})
